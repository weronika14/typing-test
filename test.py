...
def finding_speed(minutes): #returns the number of word and number of letters per minute
        ...
        num_words = int(num_words/minutes)

        return lpm, num_words


def end_screen_slow(lpm, num_words, txt):
        ...
        writingText(txt, x_coordinate, y_coordinate, 600, 100, (colour), (255,255,255), 70)
        writingText('Letters per minute:', x_coordinate, y_coordinate+80, 600, 80, (colour), (255,255,255), size)
        writingText(str(lpm), x_coordinate, (y_coordinate+160), 600, 80, (colour), (255,255,255), size)
        writingText('Words per minute:', x_coordinate, (y_coordinate+240), 600, 80, (colour), (255,255,255), size)
        writingText(str(num_words), x_coordinate, (y_coordinate+320), 600, 80, (colour), (255,255,255), size)
...
def main():
    ...
    if timer.timer == 'stop':
        ...
        if speed[1] < 44:
            end_screen_slow(speed[0], speed[1], "You're slow!")
        if speed[1] == 44:
            end_screen_slow(speed[0], speed[1], "You're average")
        if speed[1] > 44:
            end_screen_slow(speed[0], speed[1], "You're fast!")
